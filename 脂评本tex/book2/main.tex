...
\include{./TeX_files/chapter05}%+3即对应
\include{./TeX_files/chapter06}
\include{./TeX_files/chapter07}
\include{./TeX_files/chapter08}%四张图18198021.先放一下，到时要单个独立编译成功再加入整体来
...
\include{./TeX_files/chapter17}%有两张图，先放着
...
\include{./TeX_files/appendix3}
\include{./TeX_files/note}
\end{document}